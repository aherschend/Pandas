...
produce.index = ['Cost Per Pound', 'Quantity Sold', 'Total Sales']
#Transpose and keep it that way so don't have to put T everytime
# I call the list
produce = produce.T
print(produce)
...
print()
print(produce.loc['Apples':'Lettuce', ['Total Sales']])
print()
...
print()
print('Average Quantity Sold: ',produce['Quantity Sold'].mean())
print()
